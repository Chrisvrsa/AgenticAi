...
def get_files_info(working_directory, directory=None):
    ...
    if directory == None or directory == '.':
        ...
        for file_name in list_of_directories:
            ...
            final_list.append(f'- {file_name}: {file_size}, is_dir={is_directory}')
    ...
    # Do the same process after these checks. This souldnt override anything since we return at the top. The same name here is proper.
